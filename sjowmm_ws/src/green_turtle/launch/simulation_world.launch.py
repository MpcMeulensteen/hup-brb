...
WORLD_CONSTANT = 'critical_point1'
...
def generate_launch_description():
    ...
    world = os.path.join(get_package_share_directory('path_projection'), 'worlds', WORLD_CONSTANT + ".world")
    pkg_gazebo_ros = get_package_share_directory('gazebo_ros')
    
    # We use the turtlebots so we reference the description
    #robot_urdf_name = MODEL_CONSTANT + ".urdf"
    #robot_urdf = os.path.join(get_package_share_directory('dede'), 'urdf', robot_urdf_name)
